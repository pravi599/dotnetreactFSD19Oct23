...
insert into Areas(area,zipcode) values('CCC','54321')
...
--will not get inserted because of violating referrential integrity
...
---update name and employee 102
update Employees set name='Komu',age=22 where employee_id=102

select * from Employees

--delete 
delete from Skills where skill='c'--not works
--delete ftom child to delete from parent
